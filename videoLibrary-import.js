...
// Takes all the videos from a GET requests, creates HTML code, and adds it to the video library
	...
	for (var i = 0; i < entries.length; i++) {
		...
		if(typeof ie !== 'undefined'){
			html.push('><img title="',title,'"src='../../../physicians/isotope/,thumbnailUrl,' />')
		} else{ 
			html.push(' style="background:url(',thumbnailUrl,') center no-repeat">')
		}
		
		html.push('</div></a><span class="titlec"><a  class="videoLibPop side_links cboxElement" title="',title,'" href='../../../physicians/isotope/, videoUrl ,'>', title, '</a></span></div>');
	}
